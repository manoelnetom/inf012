 ...
 * @author ManoelNeto
 */
@WebServlet(name = "ForcaServlet", urlPatterns = {"/ForcaServlet"})
public class ForcaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            }else if(acao.equalsIgnoreCase("Reiniciar")){
                Forca forca= new Forca();
                HttpSession ses = request.getSession();
                ses.setAttribute("jogo", forca);
