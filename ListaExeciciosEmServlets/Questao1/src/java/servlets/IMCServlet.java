...
public class IMCServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            String botao = request.getParameter("bt");
            if (botao.equalsIgnoreCase("IMC Tradicional")) {
                out.println("<h1> " + usuario.getIMCTradicional() + "</h1>");
            } else if (botao.equalsIgnoreCase("IMC Hildenburg")) {
                out.println("<h1> " + usuario.getIMCHildenburg() + "</h1>");
            } else {
                out.println("<h1> " + usuario.getIMCOxford() + "</h1>");

            }

            out.println("<a href=\"index.html\">Clique aqui para Voltar</a>");
            out.println("</body>");
            out.println("</html>");
        }
    }
